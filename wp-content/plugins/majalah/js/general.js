(function($) {
    ...
    $(document).ready(function() {
        ...
        $('#majalah-admin .nav-tab').click(function(e) {
            e.preventDefault()
            $('#majalah-admin .tab-active').hide()
        ...
        $('#majalah-admin .nav-tab').focus(function(e) {

            this.blur()
        })

        $($('#majalah-admin .nav-tab')[0]).trigger('click')

        var $form = $('#majalah-options-form')
