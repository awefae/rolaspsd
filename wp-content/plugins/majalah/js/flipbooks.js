/*
author http://kaltim.biz/user/TukangTidurTelatBangun
*/
        ...
        function addBook(book) {
            ...
            $(  '<tr>' + 
                    ...
                    '<td style="vertical-align: top;">' + 
                        ...
                        '</div>' + 
                    '</td>' + 
                    '<td>[majalah id="' + book.id + '"]   <div id="'+book.id+'" class="button-secondary copy-shortcode">Copy</div>        </td>' + 
                    '<td>' + book.date + '</td>' + 
                '</tr>').appendTo($table)
        }
